...
wsl -d Ubuntu-22.04 -e bash -lc "sudo service docker start >/dev/null 2>&1; cd /mnt/c/Users/vovav/Desktop/fleet && sudo docker compose -f docker-compose.docker.wsl.yml up -d --build"
echo.
